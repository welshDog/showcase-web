...
import { BuildsData } from '../types/build';
  ...
  return (
    ...
    >
      ...
      <section className="px-6 py-14 md:py-24 max-w-6xl mx-auto">
        <p className="text-xs uppercase tracking-[0.35em] mb-4 font-mono" style={{ color: '#00FFE1' }}>
        ...
        <div className="grid gap-3 md:grid-cols-3 max-w-3xl mb-8">
          {[
            ...
            <div key={t} className="rounded-xl px-4 py-3 text-sm hz-card" style={{ color: '#B8C1CC' }}>
              {t}
            </div>
          ))}
        </div>
      ...
      <section id="hyper-station" className="px-6 pb-16 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-[3fr,2fr] gap-8 items-start">
          ...
          <div className="flex flex-col gap-5">
            <p className="text-xs uppercase tracking-[0.25em] font-mono" style={{ color: '#00FFE1' }}>FEATURED DEMO</p>
      ...
      <section id="builds" className="px-6 pb-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-sm font-mono" style={{ color: '#B8C1CC' }}>{builds.length} builds 🔥</p>
        </div>
      ...
      {/* FOOTER */}
      <footer className="py-12 px-6" style={{ borderTop: '1px solid rgba(0,255,225,0.1)', background: 'rgba(7,7,10,0.6)' }}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 text-sm">
          <div className="text-center md:text-left">
            <p className="mb-1 font-bold" style={{ color: '#00FFE1' }}>HYPERFOCUS Z0NE ♾️</p>
